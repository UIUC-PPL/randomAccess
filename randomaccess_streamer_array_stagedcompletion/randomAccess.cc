...
public:
    ...
    void start() {
        ...
        aggregator.init(updater_array.ckGetArrayID(), startCb, endCb, INT_MIN);
    }
...
public:
    Updater() {
        myIndex = thisIndex.data[0]; 
        globalStartmyProc = myIndex * localTableSize  ;
    ...
    void generateUpdates()
    {
        ...
        ArrayMeshStreamer<CmiUInt8, int> 
